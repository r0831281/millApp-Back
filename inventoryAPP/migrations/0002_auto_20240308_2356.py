...
from inventoryAPP.models import Item, ItemTypes, Bestelling, Location, Dienst, Role, User, UserItem
...
def create_item_types(apps, schema_editor):
    ItemTypes.objects.create(name="Laptop", description="Laptop", code="LPTP", subcategory="Laptop", quantity=5, isbulk=False)
    ItemTypes.objects.create(name="Desktop", description="Desktop", code="DSTP", subcategory="Desktop", quantity=5, isbulk=False)
    ItemTypes.objects.create(name="Server", description="Server", code="SRVR", subcategory="Server", quantity=5, isbulk=False)
    ItemTypes.objects.create(name="Monitor", description="Monitor", code="MNTR", subcategory="Monitor", quantity=5, isbulk=False)
    ItemTypes.objects.create(name="Printer", description="Printer", code="PRT", subcategory="Printer", quantity=5, isbulk=False)
    ItemTypes.objects.create(name="Scanner", description="Scanner", code="SCNR", subcategory="Scanner", quantity=5, isbulk=False)
    ItemTypes.objects.create(name="Keyboard", description="Keyboard", code="KYBD", subcategory="Keyboard", quantity=5, isbulk=False)
    ItemTypes.objects.create(name="Mouse", description="Mouse", code="MS", subcategory="Mouse", quantity=10, isbulk=False)
    ItemTypes.objects.create(name="Cable", description="Cable", code="CBL", subcategory="Cable", quantity=20, isbulk=False)
    ItemTypes.objects.create(name="Adapter", description="Adapter", code="ADPT", subcategory="Adapter", quantity=2, isbulk=False)
    ItemTypes.objects.create(name="Battery", description="Battery", code="BTRY", subcategory="Battery", quantity=1, isbulk=False)
    ItemTypes.objects.create(name="Charger", description="Charger", code="CHRGR", subcategory="Charger", quantity=3, isbulk=False)
    ItemTypes.objects.create(name="Bag", description="Bag", code="BG", subcategory="Bag", quantity=2, isbulk=False)
    ItemTypes.objects.create(name="Case", description="Case", code="CS", subcategory="Case", quantity=1, isbulk=False)
...
def create_user_items(apps, schema_editor):
    UserItem.objects.create(user_id=1, item_id=1)
    UserItem.objects.create(user_id=1, item_id=2)
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunPython(create_user_items),
